...
#define MyAppVersion "0.0.7.3"
#define MyAppURL "https://github.com/mrkenhoo/sunvalley-sr"
...
[Files]
Source: "C:\Users\{#MyUsername}\Documents\GitHub\sunvalley-sr\workstations-v2\bin\Release\netcoreapp3.1\publish\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
