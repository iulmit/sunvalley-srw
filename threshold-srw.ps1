...
Function ProgramsSetup {
    ...
    Write-Output "Uninstalling UWP apps..."
    ...
    Write-Output "WARNING: The following UWP apps has been left installed, they provide critical functionalities to the system: Windows Store, NVIDIA Control Panel and Intel Graphics Command Center"
}
